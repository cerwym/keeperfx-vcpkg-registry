...
vcpkg_cmake_install()
vcpkg_copy_pdbs()
# Upstream assumes VCPKG_TARGET_IS_WINDOWS => CMake config lands at "cmake" (no
# lib/ prefix), which holds for the MSVC triplets but not for the community
# x86-mingw-dynamic triplet (VCPKG_CMAKE_SYSTEM_NAME=MinGW): SDL3_mixer's own
# CMakeLists.txt still installs its config under "lib/cmake/SDL3_mixer" there,
# so vcpkg_cmake_config_fixup fails looking in "cmake". Detect the real
# location instead of assuming it from VCPKG_TARGET_IS_WINDOWS.
if(EXISTS "${CURRENT_PACKAGES_DIR}/cmake")
    set(SDL3_MIXER_CONFIG_PATH "cmake")
else()
    set(SDL3_MIXER_CONFIG_PATH "lib/cmake/SDL3_mixer")
endif()
vcpkg_cmake_config_fixup(PACKAGE_NAME "SDL3_mixer" CONFIG_PATH "${SDL3_MIXER_CONFIG_PATH}")
